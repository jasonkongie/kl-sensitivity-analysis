...
def main():
    ...
    # mamba2-130m-hf bundles a tokenizer, but keep tokenizer_name separate
    # so you can swap to "state-spaces/mamba2-130m" + "EleutherAI/gpt-neox-20b"
    # without touching the loader functions.
